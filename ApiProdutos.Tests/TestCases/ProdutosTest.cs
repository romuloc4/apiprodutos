...
namespace ApiProdutos.Tests.TestCases
{
    ...
    public class ProdutosTest
    {
        ...
        [Fact]
        public async Task<ProdutoGetResponse> Post_Produtos_Retun_Ok()
        {
        ...
        {
            #region Cadastrando o Modiicando os dados de um produto

            var request = await Post_Produtos_Retun_Ok();
            ...
            #region Executando o serviço de API e capturando a resposta
